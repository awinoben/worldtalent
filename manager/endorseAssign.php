        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="text-success">Assign an Expert to a Candidate</h2>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" novalidate action="endorse.php"
                                  method="post">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">First Endorser</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="firstEndorser">
                                            <option>Select Option...</option>
                                            <?php
                                            $q = "SELECT * FROM `users` where role='Expert'";
                                            $rslt = $db->query($q);
                                            while($rw = $rslt->fetch(PDO::FETCH_ASSOC)){
                                                $name = $rw['firstName']." ".$rw['middleName']." ".$rw['lastName'];
                                                ?>
                                                <option value="<?php echo $rw['userID'];?>"><?php echo $name;?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Second Endorser</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="secondEndorser">
                                            <option>Select Option...</option>
                                            <?php
                                            $q = "SELECT * FROM `users` where role='Expert'";
                                            $rslt = $db->query($q);
