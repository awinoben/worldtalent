...
if ((isset($_POST['expert'])) && (isset($_POST['candidateID'])) && (isset($_POST['genre'])) && (isset($_POST['modifiers'])) && (isset($_POST['academic'])) && (isset($_POST['occupation'])) ) {
    ...
    $genre= implode("<br> <br>",$_POST['genre']);
    $academic =implode("<br> <br>",$_POST['academic']);
    $modifiers = implode("<br> <br> ",$_POST['modifiers']);
    $occupation = implode("<br> <br> ",$_POST['occupation']);
    ...
    if ($userCount == 0) {
        ...
        try {
            ...
            header('location:conclusionshome.php');
