        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="text-success">Assigning Professional Delimeters</h2>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" novalidate action="professionaldasgn.php"
                                  method="post">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Base Standards</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" id="basestandards" name="basestandards[]" multiple="multiple">
                                            <option value="">Select Delimeter...</option>
                                            <?php
                                            $query = "SELECT * FROM `base_standards`";
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Augmenting Models</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" id="augmodels" name="augmodels[]" multiple="multiple">
                                            <option value="">Select Augmenting Model...</option>
                                            <?php
