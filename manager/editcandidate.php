                        ...
                        <div class="x_content">
                            ...
                            <div class="item form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <img class="profile_img" width="150" height="150" src="../admin/candidatephotos/<?php echo htmlentities($row['photo']);?>" alt="No Image Found!">
                    ...
                    <div class="item form-group">
                        <div class="col-sm-12">
                            <div class="card-box">
                                ...
                                <img src="../admin/candidatephotos/<?php echo htmlentities($row['photo']);?>" width="150" height="150"/>
                                <br />
