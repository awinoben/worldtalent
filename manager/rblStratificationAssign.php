                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" novalidate action="rblStratificationa.php" method="post">
                                </p>
                                ...
                                <div class="item form-group">
                                    <?php
                                    $query = "SELECT observation FROM `rblstratification_candidates` WHERE `candidateID` ='$id'";
                                    $result = $db->query($query);
