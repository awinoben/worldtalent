        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="text-success">Conclusions and Recommendations</h2>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" novalidate action="conclusionsa.php"
                                  method="post">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Talent Genre Development</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" id="genre" name="genre[]" multiple="multiple">
                                            <option value="">Select Item</option>
                                            <?php
                                            $query = "SELECT * FROM `talent_genre_development`";
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Modifiers and Enrichment Modules</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" id="modifiers" name="modifiers[]" multiple="multiple">
                                            <option value="">Select item</option>
                                            <?php
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Typical Academic Theme Scales</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" id="academic" name="academic[]" multiple="multiple">
                                            <option value="">Select item</option>
                                            <?php
                                            $query = "SELECT * FROM `academic_theme_scales`";
                                            $result = $db->query($query);
                                            for ($i = 0; $row = $result->fetch(); $i++) {
                                                ?>
                                                <option><?php echo $row['Description']; ?></option>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Potential Occupation Themes</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" id="occupation" name="occupation[]" multiple="multiple">
                                            <option value="">Select item</option>
                                            <?php
                                            $query = "SELECT * FROM `potential_occupation_themes`";
                                            $result = $db->query($query);
                                            for ($i = 0; $row = $result->fetch(); $i++) {
                                                ?>
                                                <option><?php echo $row['Description']; ?></option>
                                ...
                                <div class="form-group">
                                    <div class="col-md-3 col-md-offset-4">
                                        <button id="send" type="submit" class="btn btn-success form-control">Save</button>
                                    </div>
                                </div>
                            </form>
                        </div>
