        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="text-success">Assigning Resources</h2>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" novalidate action="resourcesa.php"
                                  method="post">
                                ...
                                <div class="item form-group" hidden>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="last-name" name="candidateID" readonly value="<?php echo $id; ?>" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" id="resourcetype" name="resourcetype">
                                            ...
                                            <?php
                                            $query = "SELECT resourcesettype FROM `resources`";
                                            $result = $db->query($query);
                                            for ($i = 0; $row = $result->fetch(); $i++) {
                                                ?>
                                                <option><?php echo $row['resourcesettype']; ?></option>
                                                <?php
                                            }
                                            ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Resource description</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" id="description" name="description">
                                            <option value="">Select description...</option>
                                            <?php
                                            $query = "SELECT description FROM `resources`";
                                            $result = $db->query($query);
                                            for ($i = 0; $row = $result->fetch(); $i++) {
                                                ?>
