                      ...
                      <button class="btn btn-primary" type="button">Go</button>
                        ...
                        <div class="x_content">
                            ...
                            <table class="table table-striped projects">
                                ...
                                $query = "SELECT * FROM `candidates` WHERE region='$region' and country='$country'";
                                ...
                                while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="prescriptiontasksAssign.php?candidateID=<?php echo $candidateID;?>" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-eye"></i>&nbsp;Assign Talent Prescription Tasks</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
