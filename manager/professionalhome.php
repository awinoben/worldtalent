                            ...
                            <table class="table table-striped projects">
                                ...
                                while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="professionaldAssign.php?candidateID=<?php echo $candidateID;?>" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-eye"></i>&nbsp;Assign Professional Delimeters</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
