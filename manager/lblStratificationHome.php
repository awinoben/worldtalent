                            ...
                            <table class="table table-striped projects">
                                ...
                                while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="lblStratificationAssign.php?candidateID=<?php echo $candidateID;?>" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i>&nbsp;Assign Domicile</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
