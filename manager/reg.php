...
// Code for move image and document into directory
        ...
        if ($userCount == 0) {
            ...
            //$registerQuery = "INSERT INTO `candidates`(`firstName`, `middleName`,`lastName`,`username`,`dob`,`age`,`gender`,`email`,`phone`,`country`,`region`,`clinicManager`,`password`,`photo`,`resume`,`assessImportance`,`profile`,`video`, `status`) 
                          //VALUES ('$fname','$mname','$lname','$username','$dob','$age','$gender','$email','$phone','$country','$region','$manager','$passwordHash','$imgnewfile','$resumedoc','$importance','$profile','$video','$status')";
