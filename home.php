       ...
       // move_uploaded_file($_FILES["resume"]["tmp_name"],"admin/resumes/".$resumedoc);
        ...
        if ($userCount == 0) {
            ...
            try {
                ...
                echo 'alert("You have successfully registered /booked your session for Gift and Talent Assessment. We will contact you shortly with further information")';
...
<header class="masthead text-center text-white">
    <div class="masthead-content">
        <div class="row">
            <div class="col-md-12">
                <h2 class="display-4">Professional and Scientific Gift & Talent Assessment Portal</h2>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a class="nav-link btn btn-success" href="#myModal" data-toggle="modal" data-target="#myModal"><h1><i class="fa fa-users text-danger"></i></h1><br/><i class="fa fa-edit"></i>&nbsp;CLICK HERE TO BEGIN YOUR GIFT AND TALENT ASSESSMENT ONLINE</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>This Online Portal starts your Professional and Scientific Assessment of your Talent / Gift and provides you with an opportunity to initiate communication with us.</p>
                    <p>Once you have registered your basic information, one of our experts will contact you with details on how to proceed further with the assessment at  the following stages:</p>
                    <p>(i) Oral Screening</p>
                    <p>(ii) Psych-Screening</p>
                    <p>(iii) Anthropo-Biometric Machine Screening</p>
                    <br>
                    <p>On completion of the full assessment to the last stage (iii) above, your report will be ready within 48 hours</p>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-lg-1">
                            <div class="p-5">
                                <p>Without knowing your talent professionally and scientifically, and getting into a learning or education system, you will be like someone swimming in the ocean without a destination</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section>
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <p>Any person pushing a learner through an academic process without knowing his/her talent, is like someone providing an injection to a patient without any medical review</p>
                            </div>
                        </div>
                    </div>
                </div>
