...
if ((isset($_POST['email'])) && (isset($_POST['password']))) {
   ...
   //encrypt password
    ...
    $userQuery = "SELECT * FROM `users` WHERE `email`='$email' AND `role`='OralScreener'";
    ...
    if ($userCount == 1) {
        ...
        $loginQuery = "SELECT * FROM `users` WHERE `email`='$email' AND `password`='$passwordHash' AND `role`='OralScreener'";
