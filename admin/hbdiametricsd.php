...
if (isset($_POST['Ai_Descp']) || isset($_POST['Bi_Descp']) || isset($_POST['Ci_Descp']) || isset($_POST['Di_Descp'])) {
    ...
    if ($_POST['quantumPoint']=="A") {
        ...
        $setupQueryA1 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Ai'";
        try {
            ...
            header('location:hbdiametricsdomiciles.php');
        ...
        $setupQueryA2 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Aii'";
        try {
        ...
        $setupQueryA3 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Aiii'";
        try {
        ...
        $setupQueryA4 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Aiv'";
        try {
    ...
    if ($_POST['quantumPoint']=="B") {
        ...
        // execute  query(insert) for quantum Ai
        $setupQueryB1 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Bi'";
        try {
        ...
        // execute  query(insert) for quantum Aii
        $setupQueryB2 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Bii'";
        try {
        ...
        $setupQueryB3 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Biii'";
        try {
        ...
        $setupQueryB4 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Biv'";
        try {
    ...
    if ($_POST['quantumPoint']=="C") {
        ...
        $setupQueryC1 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Ci'";
        try {
        ...
        $setupQueryC2 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Cii'";
        try {
        ...
        $setupQueryC3 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Ciii'";
        try {
        ...
        $setupQueryC4 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Civ'";
        try {
    ...
    if ($_POST['quantumPoint']=="D") {
        ...
        $setupQueryD1 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Di'";
        try {
        ...
        $setupQueryD2 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Dii'";
        try {
        ...
        $setupQueryD3 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Diii'";
        try {
        ...
        $setupQueryD4 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Div'";
        try {
    ...
    if ($_POST['quantumPoint']=="E") {
        ...
        $setupQueryE1 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Ei'";
        try {
        ...
        $setupQueryE2 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Eii'";
        try {
        ...
        $setupQueryE3 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Eiii'";
        try {
        ...
        $setupQueryE4 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Eiv'";
        try {
    ...
    if ($_POST['quantumPoint']=="F") {
        ...
        $setupQueryF1 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Fi'";
        try {
        ...
        $setupQueryF2 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Fii'";
        try {
        ...
        $setupQueryF3 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Fiii'";
        try {
        ...
        $setupQueryF4 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Fiv'";
        try {
    ...
    if ($_POST['quantumPoint']=="G") {
        ...
        $setupQueryG1 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Gi'";
        try {
        ...
        $setupQueryG2 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Gii'";
        try {
        ...
        $setupQueryG3 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Giii'";
        try {
        ...
        $setupQueryG4 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Giv'";
        try {
    ...
    if ($_POST['quantumPoint']=="H") {
        ...
        $setupQueryH1 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Hi'";
        try {
        ...
        $setupQueryH2 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Hii'";
        try {
        ...
        $setupQueryH3 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Hiii'";
        try {
        ...
        $setupQueryH4 = "UPDATE `hbdiametric_descp_prec` SET Descriptor=?, Prescriptor=? WHERE quantumDomicile='Hiv'";
        try {
