            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <p></p>
                            <form class="form-horizontal form-label-left" novalidate action="tdmns.php" method="post">
                                <div class="row">
                                            ...
                                            <table class="table table-striped projects">
                                                ...
                                                while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="editdomains.php?domainId=<?php echo $row['Id'] ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                                            <a href="delete.php?delete4Id=<?php echo $row['Id'];?>&&action=parmdel" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
