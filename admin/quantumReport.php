...
<div class="container body">
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="text-success">Report (Quantum Point Values)</h2>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" novalidate action="assign.php" method="post">
                                ...
                                <table class="table table-striped projects">
                                    ...
                                    <tbody>
                                <?php
                                $query = "SELECT * FROM `domicile_setup` WHERE quantumCode='A'";
    ...
    <tr>
        ...
        <td>
            <?php
            $query = "SELECT * FROM `candidate_quantum` WHERE candidateID='$id'";
            $result = $db->query($query);
            $row = $result->fetch();
            ?>
        ...
        <td>
            <a><a><?php echo $row['quantumAPrec'];?></a></a>
                                ...
                                <tr>
                                    <?php
                                    $query = "SELECT * FROM `domicile_setup` WHERE quantumCode='B'";
                                    $result = $db->query($query);
                                    $row = $result->fetch();
                                    ?>
                                    <td>
                                ...
                                <tr>
                                    <?php
                                    $query = "SELECT * FROM `domicile_setup` WHERE quantumCode='C'";
                                    $result = $db->query($query);
                                    $row = $result->fetch();
                                    ?>
                                    <td>
                                ...
                                <tr>
                                    <?php
                                    $query = "SELECT * FROM `domicile_setup` WHERE quantumCode='D'";
                                    $result = $db->query($query);
                                    $row = $result->fetch();
                                    ?>
                                    <td>
                                ...
                                <tr>
                                    <?php
                                    $query = "SELECT * FROM `domicile_setup` WHERE quantumCode='E'";
                                    $result = $db->query($query);
                                    $row = $result->fetch();
                                    ?>
                                    <td>
                                ...
                                <tr>
                                    <?php
                                    $query = "SELECT * FROM `domicile_setup` WHERE quantumCode='F'";
                                    $result = $db->query($query);
                                    $row = $result->fetch();
                                    ?>
                                    <td>
                                ...
                                <tr>
                                    <?php
                                    $query = "SELECT * FROM `domicile_setup` WHERE quantumCode='G'";
                                    $result = $db->query($query);
                                    $row = $result->fetch();
                                    ?>
                                    <td>
                                ...
                                <tr>
                                    <?php
                                    $query = "SELECT * FROM `domicile_setup` WHERE quantumCode='H'";
                                    $result = $db->query($query);
                                    $row = $result->fetch();
                                    ?>
                                    <td>
