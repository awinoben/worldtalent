...
if (isset($_POST['domicileA']) && isset($_POST['domicileB']) && isset($_POST['domicileC']) && isset($_POST['domicileD']) && isset($_POST['domicileE']) && isset($_POST['domicileF']) && isset($_POST['domicileG']) && isset($_POST['domicileH'])) {
    ...
    if ($domicileA !=null) {
        ...
        $setupQueryA1 = "UPDATE `birthscale_domicile_setup` SET quantumDescription=? WHERE quantumCode='A'";
        try {
            ...
            header('location:birthdomicilesetup.php');
    ...
    if ($domicileB !=null) {
        ...
        // execute  query(insert) for quantum Ai
        $setupQueryB1 = "UPDATE `birthscale_domicile_setup` SET quantumDescription=? WHERE quantumCode='B'";
        try {
    ...
    if ($domicileC!=null) {
        ...
        $setupQueryC1 = "UPDATE `birthscale_domicile_setup` SET quantumDescription=? WHERE quantumCode='C'";
        try {
    ...
    if ($domicileD!=null) {
        ...
        // execute  query(insert) for quantum Ci
        $setupQueryD1 = "UPDATE `birthscale_domicile_setup` SET quantumDescription=? WHERE quantumCode='D'";
        try {
    ...
    if ($domicileE!=null) {
        ...
        // execute  query(insert) for quantum Ci
        $setupQueryE1 = "UPDATE `birthscale_domicile_setup` SET quantumDescription=? WHERE quantumCode='E'";
        try {
    ...
    if ($domicileF!=null) {
        ...
        // execute  query(insert) for quantum Ci
        $setupQueryF1 = "UPDATE `birthscale_domicile_setup` SET quantumDescription=? WHERE quantumCode='F'";
        try {
    ...
    if ($domicileG) {
        ...
        // execute  query(insert) for quantum Ci
        $setupQueryG1 = "UPDATE `birthscale_domicile_setup` SET quantumDescription=? WHERE quantumCode='G'";
        try {
    ...
    if ($domicileH!=null) {
        ...
        $setupQueryH1 = "UPDATE `birthscale_domicile_setup` SET quantumDescription=? WHERE quantumCode='H'";
        try {
