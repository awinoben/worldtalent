                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            ?>
                            <form class="form-horizontal form-label-left" novalidate action="updateactivity.php" method="post">
                                <div class="row">
                                <div class="col-md-2 item form-group" hidden>
                                        ...
                                        <div class="col-xs-12">
                                            <input id="activityId" value="<?php echo $id; ?>" class="form-control col-md-7 col-xs-12" type="text" placeholder="id.." name="activityId">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control col-md-7 col-xs-12" id="activityset" name="activityset" readonly="true">
                                    <option value="<?php echo $row['activityset']; ?>"><?php echo $row['activityset']; ?></option>
                                </select>
                            </div>
                          </div>
                                    ...
                                    <div class="col-md-3 item form-group">
                                        ...
                                        <div class="col-xs-12">
                                            <input id="activitysettype" value="<?php echo $row['activitysettype']; ?>" class="form-control col-md-7 col-xs-12"  type="text" name="activitysettype">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
