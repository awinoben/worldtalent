        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Update Talent Genre Development</h2>
                        ...
                        <div class="x_content">
                            ...
                            $Query = "SELECT * FROM `talent_genre_development` WHERE `Id`='$id'";
                            ...
                            ?>
                            <form class="form-horizontal form-label-left" novalidate action="updatetalentgnr.php" method="post">
                                <div class="row">
                                    <div class="col-md-2 item form-group" hidden>
                                        ...
                                        <div class="col-xs-12">
                                            <input id="genreId" value="<?php echo $id; ?>" class="form-control col-md-7 col-xs-12" type="text" placeholder="code.." name="genreId">
                                        </div>
                                    </div>
                                    <div class="col-md-2 item form-group">
                                        ...
                                        <div class="col-xs-12">
                                            <input id="code" value="<?php echo $row['Code'];?>" class="form-control col-md-7 col-xs-12" type="text" placeholder="code.." name="code">
                                        </div>
                                    </div>
                                    <div class="col-md-2 item form-group">
                                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Group</label>
                                        <div class="col-xs-12">
                                            <input id="group" value="<?php echo $row['Grp'];?>"  class="form-control col-md-7 col-xs-12" placeholder="group.." type="text" name="group">
                                        </div>
                                    </div>
