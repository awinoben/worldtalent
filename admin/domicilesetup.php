            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
              <p></p>
                    <form class="form-horizontal form-label-left" novalidate action="dsetup.php" method="post">
                        <?php
                        ...
                        ?>
						  <div class="item form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Enter Quantum Domicile A</label>
						  ...
						  <div class="item form-group">
                              ...
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Enter Quantum Domicile B</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              ...
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Enter Quantum Domicile C</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              ...
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Enter Quantum Domicile D</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              ...
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Enter Quantum Domicile E</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              ...
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Enter Quantum Domicile F</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              ...
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Enter Quantum Domicile G</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              ...
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Enter Quantum Domicile H</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
