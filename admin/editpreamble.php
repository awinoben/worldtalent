                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            ?>
                            <form class="form-horizontal form-label-left" novalidate action="updatepreamble.php" method="post">
                                <div class="row">
                                <div class="item form-group" hidden>
                                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12 text-primary">Id</label>
                                        <div class="col-xs-12">
                                            <input id="preambleId" value="<?php echo $id; ?>" class="form-control col-md-7 col-xs-12" type="text" placeholder="preamid.." name="preambleId">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label for="middle-name" class="control-label col-md-2 col-sm-2 col-xs-12">Select Preamble</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-7 col-xs-12" id="preamble" name="preamble" readonly="true">
                                            <option value="<?php echo $row['preamble']; ?>"><?php echo $row['preamble']; ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <textarea type="text" id="description" name="description" class="form-control col-md-7 col-xs-12"><?php echo $row['description']; ?></textarea>
                                    </div>
                                </div>
