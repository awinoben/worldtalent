            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
              <p></p>
                    <form class="form-horizontal form-label-left" novalidate action="d.php" method="post">
                      </p>
					  ...
					  <div id="qpointA">
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Ai'";
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Aii'";
                              $result = $db->query($query);
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Aiii'";
                              $result = $db->query($query);
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Aiv'";
                              $result = $db->query($query);
                              $row3 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Aiv_Descp</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <div class="item form-group">
                             <?php
                             $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Ai'";
                             $result = $db->query($query);
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Aii'";
                              $result = $db->query($query);
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Aiii'";
                              $result = $db->query($query);
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Aiv'";
                              $result = $db->query($query);
                              $row6 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Aiv_Prec</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div id="qpointB" hidden>
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Bi'";
                              $result = $db->query($query);
                              $row7 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Bi_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Bii'";
                              $result = $db->query($query);
                              $row8 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Bii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Biii'";
                              $result = $db->query($query);
                              $row9 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Biii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Biv'";
                              $result = $db->query($query);
                              $row9 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Biv_Descp</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <div class="item form-group">
                             <?php
                             $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Bi'";
                             $result = $db->query($query);
                             $row10 = $result->fetch(PDO::FETCH_ASSOC);
                             ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Bi_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Bii'";
                              $result = $db->query($query);
                              $row11 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Bii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Biii'";
                              $result = $db->query($query);
                              $row12 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Biii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Biv'";
                              $result = $db->query($query);
                              $row12 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Biv_Prec</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div id="qpointC" hidden>
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Ci'";
                              $result = $db->query($query);
                              $row13 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Ci_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Cii'";
                              $result = $db->query($query);
                              $row14 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Cii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Ciii'";
                              $result = $db->query($query);
                              $row15 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Ciii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Civ'";
                              $result = $db->query($query);
                              $row15 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Civ_Descp</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <div class="item form-group">
                             <?php
                             $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Ci'";
                             $result = $db->query($query);
                             $row16 = $result->fetch(PDO::FETCH_ASSOC);
                             ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Ci_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Cii'";
                              $result = $db->query($query);
                              $row17 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Cii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Ciii'";
                              $result = $db->query($query);
                              $row18 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Ciii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                          <?php
                          $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Civ'";
                          $result = $db->query($query);
                          $row18 = $result->fetch(PDO::FETCH_ASSOC);
                          ?>
                          <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Civ_Prec</label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div id="qpointD" hidden>
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Di'";
                              $result = $db->query($query);
                              $row19 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Di_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Dii'";
                              $result = $db->query($query);
                              $row20 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Dii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Diii'";
                              $result = $db->query($query);
                              $row21 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Diii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Div'";
                              $result = $db->query($query);
                              $row21 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Div_Descp</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <div class="item form-group">
                             <?php
                             $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Di'";
                             $result = $db->query($query);
                             $row22 = $result->fetch(PDO::FETCH_ASSOC);
                             ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Di_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Dii'";
                              $result = $db->query($query);
                              $row23 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Dii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Diii'";
                              $result = $db->query($query);
                              $row24 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Diii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Div'";
                              $result = $db->query($query);
                              $row24 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Div_Prec</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div id="qpointE" hidden>
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Ei'";
                              $result = $db->query($query);
                              $row25 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Ei_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Eii'";
                              $result = $db->query($query);
                              $row26 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Eii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Eiii'";
                              $result = $db->query($query);
                              $row27 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Eiii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Eiv'";
                              $result = $db->query($query);
                              $row27 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Eiv_Descp</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <div class="item form-group">
                             <?php
                             $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Ei'";
                             $result = $db->query($query);
                             $row28 = $result->fetch(PDO::FETCH_ASSOC);
                             ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Ei_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Eii'";
                              $result = $db->query($query);
                              $row29 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Eii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Eiii'";
                              $result = $db->query($query);
                              $row30 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Eiii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Eiv'";
                              $result = $db->query($query);
                              $row30 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Eiv_Prec</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div id="qpointF" hidden>
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Fi'";
                              $result = $db->query($query);
                              $row31 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Fi_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Fii'";
                              $result = $db->query($query);
                              $row32 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Fii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Fiii'";
                              $result = $db->query($query);
                              $row33= $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Fiii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Fiv'";
                              $result = $db->query($query);
                              $row33= $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Fiv_Descp</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <div class="item form-group">
                             <?php
                             $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Fi'";
                             $result = $db->query($query);
                             $row34 = $result->fetch(PDO::FETCH_ASSOC);
                             ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Fi_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Fii'";
                              $result = $db->query($query);
                              $row35 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Fii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Fiii'";
                              $result = $db->query($query);
                              $row36 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Fiii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Fiv'";
                              $result = $db->query($query);
                              $row36 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Fiv_Prec</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div id="qpointG" hidden>
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Gi'";
                              $result = $db->query($query);
                              $row37 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Gi_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Gii'";
                              $result = $db->query($query);
                              $row38 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Gii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Giii'";
                              $result = $db->query($query);
                              $row39 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Giii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Giv'";
                              $result = $db->query($query);
                              $row39 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Giv_Descp</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <div class="item form-group">
                             <?php
                             $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Gi'";
                             $result = $db->query($query);
                             $row40 = $result->fetch(PDO::FETCH_ASSOC);
                             ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Gi_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Gii'";
                              $result = $db->query($query);
                              $row41 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Gii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Giii'";
                              $result = $db->query($query);
                              $row42 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Giii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Giv'";
                              $result = $db->query($query);
                              $row42 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Giv_Prec</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div id="qpointH" hidden>
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Hi'";
                              $result = $db->query($query);
                              $row43 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Hi_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Hii'";
                              $result = $db->query($query);
                              $row44 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Hii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Hiii'";
                              $result = $db->query($query);
                              $row45 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Hiii_Descp</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Descriptor FROM `descp_prec` WHERE quantumDomicile='Hiv'";
                              $result = $db->query($query);
                              $row45 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Hiv_Descp</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <div class="item form-group">
                             <?php
                             $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Hi'";
                             $result = $db->query($query);
                             $row46 = $result->fetch(PDO::FETCH_ASSOC);
                             ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Hi_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Hii'";
                              $result = $db->query($query);
                              $row47 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Hii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
						  ...
						  <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Hiii'";
                              $result = $db->query($query);
                              $row48 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Hiii_Prec</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="item form-group">
                              <?php
                              $query = "SELECT Prescriptor FROM `descp_prec` WHERE quantumDomicile='Hiv'";
                              $result = $db->query($query);
                              $row48 = $result->fetch(PDO::FETCH_ASSOC);
                              ?>
                              <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Enter Quantum Domicile Hiv_Prec</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
