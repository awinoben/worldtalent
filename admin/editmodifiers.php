        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Update Modifiers and Enrichment Modules</h2>
                        ...
                        <div class="x_content">
                            ...
                            ?>
                            <form class="form-horizontal form-label-left" novalidate action="updatemdfs.php" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 item form-group" hidden>
                                        ...
                                        <div class="col-xs-12">
                                            <input id="modifierId" value="<?php echo $id; ?>" class="form-control col-md-7 col-xs-12" type="text" placeholder="code.." name="modifierId">
                                        </div>
                                    </div>
