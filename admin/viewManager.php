                        ...
                        <div class="x_title">
                            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-left top_search">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Search for clinic Manager...">
                      ...
                      <button class="btn btn-primary" type="button">Go</button>
                        ...
                        <div class="x_content">
                            ...
                            <table class="table table-striped projects">
                                ...
                                <tr>
                                    <th style="width: 1%">#</th>
                                    <th style="width: 15%">Clinic Manager</th>
                                ...
                                while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editmanager.php?userID=<?Php echo $row['userID'] ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                            <a href="delete.php?deletepsychoId=<?Php echo $row['userID'] ?>&&action=parmdel" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                        </td>
                                    </tr>
                                    <?php
                                }
