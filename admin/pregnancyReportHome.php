                        ...
                        <div class="x_title">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-left top_search">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="term" placeholder="Search for candidate...">
                                    <span class="input-group-btn">
                      <button class="btn btn-primary" name="submit" type="button">Go</button>
                    </span>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped projects">
                                ...
                                while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="pregnancyReport.php?candidateID=<?php echo $candidateID;?>" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-eye"></i>&nbsp;View Report</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
