...
if ((isset($_POST['genreId'])) && (isset($_POST['code'])) && (isset($_POST['group'])) && (isset($_POST['description']))) {
    $code = $_POST['code'];
    $group = $_POST['group'];
    ...
    if ($count > 0) {
        ...
        $registerQuery = "UPDATE `talent_genre_development` SET Code=?, Grp=?,Description=? WHERE Id=$id";
        try {
